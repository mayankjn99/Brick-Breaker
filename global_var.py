...
Enemy = objects.UFO(config.ufo,50,6)
bomb = objects.Bomb(config.Bomb,Enemy.xcord,Enemy.ycord)
fire_bullet = objects.shoot_bullet(config.bullet,Paddle.xcord,Paddle.ycord)
xspeed_before =0 
yspeed_before =1
l1=0
l2=0
...
#     for i in range(1,90):
#         brick1.append(objects.Brick_l1(config.brick,i,9))
